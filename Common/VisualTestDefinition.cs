...
namespace Common
{
    public abstract class VisualTestDefinition : IDisposable
    {
        ...
        public GraphicsContext CreateGraphicsContext(SwapChainDescription? swapChainDescriptor = null, GraphicsBackend? prefferedBackend = null, bool vSync = false)
        {
            ...
            if (swapChainDescriptor != null)
            {
                ...
                this.swapChain.VerticalSync = vSync;
            }
        ...
        public virtual SwapChainDescription CreateSwapChainDescription(uint width, uint height, PixelFormat pixelFormat, bool windowed)
        {
            return new SwapChainDescription()
            {
                Width = width,
